        ...
        <header id="home" class="navbar-fixed-top">
            ...
            <div class="main_menu_bg">
                <div class="container">
                  ...
                  @endif
                                        <li><a href="/house/1" class="booking">Booking NOW!</a></li>
                                    </ul>
                                </div><!-- /.navbar-collapse -->
                            </div><!-- /.container-fluid -->
                        </nav>
                        ...
                        <div class="main_slider text-center">
                            <div class="col-md-12">
                                <div class="main_slider_content wow zoomIn" data-wow-duration="1s">
                                    ...
                                    <p>Welcome to Granny House Madeira </p>
                                    <button href="/house/1" class="btn-lg">See Accomodation </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="">
                        ...
                        <div class="col-md-6">
                            <div class="single_abouts_text wow slideInRight" data-wow-duration="1s">
                                <h4>About us</h4>
                                <h3>WE ARE QUIET, RELAX AND SIMPLE</h3>
                                <p></p>
